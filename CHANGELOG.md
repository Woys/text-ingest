...
### Added
- Comprehensive architecture documentation (`assets/ARCHITECTURE.md`)
- Public API and compatibility contract guide (`assets/API_CONTRACT.md`)
- Operations and deployment guide (`assets/OPERATIONS.md`)
- Release process and maintainer checklist (`assets/RELEASE_PROCESS.md`)
- Open source standards policy (`assets/OPEN_SOURCE_STANDARDS.md`)
- Governance model (`assets/GOVERNANCE.md`)
