...
class NormalizedRecord(BaseModel):
    ...
    def to_output_dict(self, *, include_raw_payload: bool = True) -> dict[str, Any]:
        ...
        # for generating the output row, reducing per-record serialization overhead.
        # WARNING: This optimization assumes a flat model. Adding nested Pydantic
        # models, computed fields, aliases, or `@field_serializer` decorators
        # to this class in the future will NOT be serialized correctly here.
